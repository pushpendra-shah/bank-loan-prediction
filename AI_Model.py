...
# 1. Dummy Data banana (Real world mein ye bada dataset hota hai)
# Columns: [Income, LoanAmount, CreditScore, Education(1=Graduate, 0=Not)]
data = {
...
# 4. Model ko save karna taaki FastAPI iska use kar sake
